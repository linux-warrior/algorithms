...
# -- Временная сложность --
#
# Временная сложность алгоритма Прима при использовании списков смежности и очереди с приоритетом
# для ребер на основе бинарной кучи в среднем составляет `O(|E| log |V|)`, где `|V|` — число вершин
# графа, а `|E|` — число его ребер.
#
